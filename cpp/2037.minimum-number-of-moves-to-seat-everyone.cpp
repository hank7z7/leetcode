...
int main(int argc, char **argv)
{
    Solution sol;
    // Test_1
    vector<int> seats_1 = {3, 1, 5};
    vector<int> students_1 = {2, 7, 4};
    int result_1 = sol.minMovesToSeat(seats_1, students_1);
    cout << result_1 << endl;
    assert(result_1 == 4);

    // Test_2
    vector<int> seats_2 = {4, 1, 5, 9};
    vector<int> students_2 = {1, 3, 2, 6};
    int result_2 = sol.minMovesToSeat(seats_2, students_2);
    cout << result_2 << endl;
    assert(result_2 == 7);

    // Test_3
    vector<int> seats_3 = {2, 2, 6, 6};
    vector<int> students_3 = {1, 3, 2, 6};
    int result_3 = sol.minMovesToSeat(seats_3, students_3);
    cout << result_3 << endl;
    assert(result_3 == 4);
...
// Accepted
// 262/262 cases passed (7 ms)
// Your runtime beats 60.18 % of cpp submissions
// Your memory usage beats 52.06 % of cpp submissions (20.9 MB)